...
export function AdminSidebar() {
  ...
  return (
    <Sidebar className={`${collapsed ? "w-16" : "w-64"} bg-foreground border-r border-primary/20`} collapsible="icon">
      <SidebarHeader className="border-b border-primary/20 p-4 bg-foreground">
      ...
      <SidebarContent className="p-2 bg-foreground">
        <SidebarGroup>
      ...
      <SidebarFooter className="border-t border-primary/20 p-4 space-y-2 bg-foreground">
        <Button
          variant="ghost"
          size="sm"
          onClick={() => navigate("/")}
